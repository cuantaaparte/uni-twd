export class AdminModalsView {
    constructor() {
        this.inyectarModales();
    }

    inyectarModales() {
        if (document.getElementById("modal-operacion")) return; // Evita duplicados
        
        /* html */
        const html = `
            ${this.#getModalEditarOperacion()}
            ${this.#getModalCrearOperacion()}
            ${this.#getModalUsuarios()}
            ${this.#getModalDetalle()}
            ${this.#getModalOperadores()}
            ${this.#getModalPuntos()}
        `;
        document.body.insertAdjacentHTML("beforeend", html);
    }

    #getModalEditarOperacion() {
        /* html */
        return `
